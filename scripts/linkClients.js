    ...
    try {
        ...
        for (const client of clientsToLink) {
            ...
            if (!isLinked) {
                ...
                console.log(`Client ${client} is already linked to file ID ${fileId}. Skipping.`);
            }
        }
        ...
        if (clientsNotLinked.length > 0) {
            ...
            console.log(`Clients successfully linked to file ID: ${fileId} in block: ${receipt.blockNumber}`);
        } else {
